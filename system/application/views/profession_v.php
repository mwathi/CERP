...
<table>
    <?php echo form_open('flock_management/professionListing');?>
    <td>
        <select name="profession" id="profession">
            <option value="" selected>Select Profession</option>
            <?php
                foreach ($allprofessions as $profess) {
                echo "<option selected value='$profess->Profession'>$profess->Profession</option>";
                }
            ?>
        </select>
    </td>
    <td>
        <input type="submit" name="professionsubmit" value="Filter Group" class="button" />
    </td>
    <?php echo form_close();?>
</table>  
 <div align="center">
        ...
        <table class="reporttable">
            ...
            <tr class="yellow">
                ...
                <th>Email Address</th>                
                    ...
                    <?php
                    foreach($professions as $member_data){?>
                        <tr>                                                                        
