...
<div id="view_content">
    ...
    <a class="action_button" id="balances" href="<?php echo site_url("balances_management"); ?>">Balances</a>
    <a class="action_button" id="suppliers" href="<?php echo site_url("supplier_management"); ?>">Suppliers</a>
    <a class="action_button" id="accounts" href="<?php echo site_url("account_management"); ?>">Accounts</a>
    <a class="action_button" id="cheques" href="<?php echo site_url("cheque_management"); ?>">Cheques</a>
            ...
            <tr class="yellow">                
                ...
                <th>Opening Balance Date</th>
                    ...
                    foreach($church as $church_data){?>
                        <tr>                                                                        
                        <td><?php echo $church_data -> Account_Name ?></td>                                                                      
                        <td><?php echo $church_data -> Banks -> Name ?></td>      
                        <td><?php echo $church_data -> Account_Number?></td>
                        <td><?php echo "KES&nbsp<b>".number_format($church_data -> Balance) ."</b>"; ?></td>
