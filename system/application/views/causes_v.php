            ...
            <tr class="yellow">
                ...
                <th>Deadline</th>                        
                    ...
                    foreach($causedata as $cause_data){?>
                        ...
                        <td style="text-align: right"><?php if($cause_data -> Target != 0){echo number_format($cause_data -> Target);} ?></td>
                        
                        <td><?php if($cause_data -> Deadline != ""){echo date('F Y D', strtotime($cause_data -> Deadline));} ?></td>                 
