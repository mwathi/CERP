...
<table>
    <?php echo form_open('flock_management/genderListing');?>
    <td>
        <select name="member_gender" id="member_gender">
            <option value="" selected>Select gender</option>
            <?php
                foreach ($allgenders as $gend) {
                echo "<option selected value='$gend->Gender'>$gend->Gender</option>";
                }
            ?>
        </select>
    </td>
    <td>
        <input type="submit" name="gendersubmit" value="Filter Group" class="button" />
    </td>
    <?php echo form_close();?>
</table>  
 <div align="center">
        ...
        <table class="reporttable">
            ...
            <tr class="yellow">
                ...
                <th>Email Address</th>                
                    ...
                    <?php
                    foreach($genders as $member_data){?>
                        <tr>                                                                        
